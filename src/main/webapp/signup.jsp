...
<body style="background-image: url('assets/agera.jpg');background-size: 100%">
    ...
    <form action="user" method="post">
        ...
        <h4 class="mb-3 text-center"  >Please Sign Up</h4>
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <input type="text" id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Enter Your Password" class="form-control" required="required" autofocus>
        </div>
